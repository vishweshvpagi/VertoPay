...
export default function LoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      // ✅ On web, router.replace('/') is enough — no setTimeout needed
      // setTimeout caused a race where navigation fired before state updated
      if (Platform.OS === "web") {
        router.replace("/");
      } else {
                ...
                <Link href="/(auth)/register" asChild>
                  ...
                  >
                    ...
                    >
                      ...
                      <Text
                        style={[styles.linkBold, { color: colors.primary }]}
                      >
                        Register
                      </Text>
                    </Text>

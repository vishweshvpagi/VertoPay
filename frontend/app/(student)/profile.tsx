...
export default function ProfileScreen() {
  ...
  const loadStats = async () => {
    ...
    try {
      ...
      const txnData = await apiRequest<{ transactions: any[] }>(
  ...
  // ✅ handleLogout is now properly defined inside the component
  const handleLogout = async () => {
    // ✅ Alert doesn't work on web — use window.confirm instead
    if (Platform.OS === "web") {
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <SafeAreaView style={styles.safeArea} edges={["top"]}>
        ...
        >
          ...
          >
            ...
            {user?.studentId && (
              ...
              >
                ...
                <Text style={[styles.studentIdText, { color: colors.student }]}>
                  {user.studentId}
                </Text>
              </View>
            )}
          ...
          <View style={styles.section}>
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                Alert.alert(
                  "Help & Support",
                  "Contact support at support@vertopay.com",
                )
              }
            >
              <View
          ...
          {/* ✅ Logout button — calls handleLogout which is now properly defined */}
          <View style={styles.section}>
            <TouchableOpacity
              style={[
                styles.logoutButton,
